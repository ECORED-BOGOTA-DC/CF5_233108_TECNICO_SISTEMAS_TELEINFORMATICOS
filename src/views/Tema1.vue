...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-7
        ...
        .row.justify-content-center.align-items-center.mb-3
          ...
          .col-10.col-lg-11
            p Teniendo en cuenta los ejemplos humanos y de redes anteriores, el intercambio de mensajes y las acciones realizadas cuando se envían y reciben estos mensajes son los elementos clave que definen un protocolo: 
        ...
        p Internet, y las redes informáticas en general, hacen un amplio uso de los protocolos. Se utilizan distintos protocolos para realizar diferentes tareas de comunicación. A medida que vaya leyendo este componente, aprenderá que algunos protocolos son simples y sencillos, mientras que otros son complejos e intelectualmente profundos. Dominar el campo de las redes informáticas equivale a comprender <b>el qué, el por qué y el cómo</b> de los protocolos de red.
    ...
    .bg-fondo1
      .row.justify-content-center.align-items-center.mb-5
        figure(data-aos="fade-right")
          img(src='@/assets/curso/temas/tema1/img20.png', alt='Imágen decorativa')    
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-10.col-lg-11
        p La FTTH puede proporcionar potencialmente velocidades de acceso a Internet del orden de los gigabits por segundo. Sin embargo, la mayoría de los ISP de FTTH ofrecen diferentes tarifas, y las más altas cuestan naturalmente más dinero. La mayoría de los clientes de FTTH disfrutan hoy de tarifas de descarga de entre 10 y 20 Mbps y de subida de entre 2 y 10 Mbps. Además del acceso a Internet, las fibras ópticas transportan servicios de televisión y telefonía tradicional.
